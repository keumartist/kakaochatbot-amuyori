						...
						carousel: {
							...
							items: [
								...
								},
								{
									...
									thumbnail: {
										imageUrl: processImages[0]
									}
								},
								{
									description: process[1],
									thumbnail: {
										imageUrl: processImages[1]
									}
								},
								{
									description: process[2],
									thumbnail: {
										imageUrl: processImages[2]
									}
								},
								{
									description: process[3],
									thumbnail: {
										imageUrl: processImages[3]
									}
								},
								{
									description: process[4],
									thumbnail: {
										imageUrl: processImages[4]
									}
								},
								{
									description: process[5],
									thumbnail: {
										imageUrl: processImages[5]
									}
								},
								{
									description: process[6],
									thumbnail: {
										imageUrl: processImages[6]
									}
								},
								{
									description: process[7],
									thumbnail: {
										imageUrl: processImages[7]
									}
								},
								{
									description: process[8],
									thumbnail: {
										imageUrl: processImages[8]
									}
								}
							]
						}
